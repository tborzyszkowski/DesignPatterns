...
{
    public class MarsFactory : MethodFactory
    {
        private static readonly Lazy<MarsFactory> MethodInstance =
            new Lazy<MarsFactory>(() => Activator.CreateInstance(typeof(MarsFactory), nonPublic: true) as MarsFactory);
        public static MarsFactory Instance
        {
