...
{
    public class EarthFactory : MethodFactory
    {
        private static readonly Lazy<EarthFactory> MethodInstance =
            new Lazy<EarthFactory>(() => Activator.CreateInstance(typeof(EarthFactory), nonPublic: true) as EarthFactory);
        public static EarthFactory Instance
        {
            get { return MethodInstance.Value; }
        }
        //private EarthFactory() { }
